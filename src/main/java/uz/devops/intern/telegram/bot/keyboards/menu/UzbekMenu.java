...
//@Getter
//@Service
public class UzbekMenu implements AdminMenu{
    private final String LANGUAGE = "uz";

    private ResourceBundle bundle = ResourceBundleUtils.getResourceBundleByUserLanguageCode(LANGUAGE);
