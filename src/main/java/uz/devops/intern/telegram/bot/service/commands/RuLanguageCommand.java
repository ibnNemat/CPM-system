...
@Service
public class RuLanguageCommand extends BotCommandAbs {

    private final String COMMAND = "/ru";
    private final String LANGUAGE_CODE = "ru";

    protected RuLanguageCommand(AdminFeign adminFeign) {
        super(adminFeign);
    }
