...
@Service
public class UzLanguageCommand extends BotCommandAbs {

    private final String COMMAND = "/uz";
    private final String LANGUAGE_CODE = "uz";

    protected UzLanguageCommand(AdminFeign adminFeign) {
        super(adminFeign);
    }
