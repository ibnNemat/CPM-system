...
import uz.devops.intern.repository.RoleRepository;
import uz.devops.intern.service.RoleService;
import uz.devops.intern.service.dto.RoleDTO;
import uz.devops.intern.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uz.devops.intern.domain.Role}.
 */
@RestController
@RequestMapping("/api")
