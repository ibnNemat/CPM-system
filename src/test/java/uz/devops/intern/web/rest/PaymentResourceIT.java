...
class PaymentResourceIT {
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.paymentForPeriod(UPDATED_PAYMENT_FOR_PERIOD).isPayed(UPDATED_IS_PAYED).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentForPeriod(UPDATED_PAYMENT_FOR_PERIOD).isPayed(UPDATED_IS_PAYED).createdAt(UPDATED_CREATED_AT);
